			...
			<header className='sticky top-0 bg-base-100/80 backdrop-blur shadow z-40'>
				<div className="flex justify-between gap-12 lg:gap-20 max-w-7xl mx-auto px-4 py-3 md:pt-5">
					<a href="/#" className='flex gap-2 items-center hover:bg-base-200 rounded'>
						...
						<div>
							<h1 className='text-lg leading-4 md:text-2xl md:leading-6 title2'>Future<span className='font-bold text-gradient bg-gradient-to-bl from-[#FFCE15] to-[#FF9900]'>Vuls</span></h1>
						</div>
					</a>
			...
			<main>
							...
							<CarouselContent>
									...
									<Card>
										<CardHeader>
											<CardTitle className='h-8 flex flex-row items-center mx-auto text-lg'>
												<img className='max-w-full shrink object-contain' src="./jtb.png" alt="株式会社JTB" />
										...
										<CardContent>
											...
											<h5 className='h-16 mt-6 font-medium text-xl text-center'>
								...
								<CarouselItem className="basis-1/3">
									<Card>
										<CardHeader>
											<CardTitle className='h-8 flex flex-row items-center mx-auto text-lg'>
												<img className='max-w-full shrink object-contain' src="./smart_hr.png" alt="株式会社SmartHR" />
								...
								<CarouselItem className="basis-1/3">
									<Card>
										<CardHeader>
											<CardTitle className='h-8 flex flex-row items-center mx-auto text-lg'>
												<img className='max-w-full shrink object-contain' src="./akatsuki.png" alt="株式会社アカツキ" />
								...
								<CarouselItem className="basis-1/3">
									<Card>
										<CardHeader>
											<CardTitle className='h-8 flex flex-row items-center mx-auto text-lg'>
												<img className='max-w-full shrink object-contain' src="./sompo.png" alt="損害保険ジャパン株式会社" />
								...
								<CarouselItem className="basis-1/3">
									<Card>
										<CardHeader>
											<CardTitle className='h-8 flex flex-row items-center mx-auto text-lg'>
												<img className='max-w-full shrink object-contain' src="./mainavi.png" alt="株式会社JTB" />
												<h4 className='flex-none ml-3 text-[#333333] whitespace-nowrap'>株式会社JTB 様</h4>
											</CardTitle>
										</CardHeader>
										<CardContent>
					...
					<div className='max-w-7xl mx-auto px-4 py-10 md:pt-20 md:pb-20'>
						<div className='flex items-center lg:items-start justify-center flex-col lg:flex-row lg:gap-12 mb-8 md:mb-16'>
							<div className='flex flex-col text-center w-full'>
								<h2 className='md:text-lg font-bold text-gradient bg-gradient-to-bl from-[#FFCE15] to-[#FF9900]'>HOW IT WORKS</h2>
				...
				<section id='特徴'>
					<div className='max-w-7xl mx-auto px-4 py-10 md:pt-20 md:pb-20'>
						<div className='flex items-center lg:items-start justify-center flex-col lg:flex-row lg:gap-12 mb-8 md:mb-16'>
							<div className='flex flex-col text-center w-full'>
								<h2 className='md:text-lg font-bold text-gradient bg-gradient-to-bl from-[#FFCE15] to-[#FF9900]'>FEATURES</h2>
...
システム内の脆弱性を可視化し、対応が必要な脆弱性に注力できます
				...
				<section id='料金' className='bg-gradient-to-bl from-[#FFCE15]/[0.10] to-[#FF9900]/[0.10]'>
					<div className='max-w-7xl mx-auto px-4 py-10 md:pt-20 md:pb-20'>
						<div className='flex items-center lg:items-start justify-center flex-col lg:flex-row lg:gap-12 mb-8 md:mb-16'>
							<div className='flex flex-col text-center w-full'>
								<h2 className='md:text-lg font-bold text-gradient bg-gradient-to-bl from-[#FFCE15] to-[#FF9900]'>PRICING</h2>
							...
							<div className="w-5/6 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0 rounded-lg md:rounded-xl shadow-[0_0_25px_rgba(235,87,87,0.27)]">
								...
								<div className="bg-white p-8 rounded-lg md:rounded-none md:rounded-l-xl shadow-md flex flex-col justify-between items-center">
									<div className='w-full'>
										<h3 className='md:text-md font-bold text-gradient bg-gradient-to-bl from-[#FFCE15] to-[#FF9900]'>OSS Vuls</h3>
										<h4 className='text-xl font-bold mb-4'>オープンソースVuls</h4>
										<p className='mb-4 text-[#333333]'>脆弱性をスキャン</p>
										<p className='text-lg md:text-2xl text-[#333333] font-bold tracking-tighter pb-8 md:pb-10'>
											<span className='text-4xl font-black'>無料</span>
										</p>
								...
								<div className="bg-white p-8 shadow-md flex flex-col justify-between items-center">
									<div className='w-full'>
										<h3 className='md:text-md font-bold text-gradient bg-gradient-to-bl from-[#FFCE15] to-[#FF9900]'>Standard</h3>
										<h4 className='text-xl font-bold mb-4'>FutureVuls Standard</h4>
										<p className='mb-4 text-[#333333]'>脆弱性を管理</p>
										<p className='text-lg md:text-xl text-[#333333] font-bold tracking-tighter pb-8 md:pb-10'>
											<span className='text-4xl font-black'>4,000</span>円より
										</p>
										<ul className='text-md text-[#333333] pb-10 md:pb-12'>
											<li className='flex items-center justify-start lg:justify-start gap-1.5 pb-1 mb-1'>
												<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6 text-green-500">
								...
								<div className="bg-white p-8 rounded-lg md:rounded-none md:rounded-r-xl shadow-md flex flex-col justify-between items-center">
									<div className='w-full'>
										<h3 className='md:text-md font-bold text-gradient bg-gradient-to-bl from-[#FFCE15] to-[#FF9900]'>CSIRT</h3>
										<h4 className='text-xl font-bold mb-4'>FutureVuls CSIRT</h4>
										<p className='mb-4 text-[#333333]'>全社の脆弱性を横断管理</p>
										<p className='text-lg md:text-2xl text-[#333333] font-bold tracking-tighter pb-8 md:pb-10'>
											<span className='text-4xl font-black'>要見積</span>
										</p>
										<ul className='text-md text-[#333333] pb-10 md:pb-12'>
											<li className='flex items-center justify-start lg:justify-start gap-1.5 pb-1 mb-1'>
												<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6 text-green-500">
					...
					<div className='grid grid-cols-2 md:grid-cols-5 gap-2 lg:gap-6 px-0 md:px-20'>
						...
						<div className='col-span-1 text-sm text-center md:text-left mb-4 md:mb-0'>
							...
							<ul className='text-[#828282] leading-relaxed md:leading-loose'>
								<li>導入事例</li>
								<li>特徴</li>
								<li>FutureVulsの仕組み</li>
								<li>セキュリティコンサルティング</li>
							</ul>
						</div>
						<div className='col-span-1 text-sm text-center md:text-left mb-4 md:mb-0'>
